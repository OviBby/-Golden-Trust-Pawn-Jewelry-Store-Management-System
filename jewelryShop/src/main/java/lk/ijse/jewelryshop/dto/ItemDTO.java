...
public class ItemDTO {
    ...
    public ItemDTO(String itemId, String description, String metalType, double weightGrams, String purity, double price, String addedDate, String currentStockStatus, int qty, double unitPrice) {
        this.itemId = itemId;
    ...
    public ItemDTO(String description, int qty, double weightGrams, String purity, double unitPrice) {
        this.description = description;
        this.qty = qty;
