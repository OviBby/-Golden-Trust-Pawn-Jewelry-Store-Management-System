...
public class PawnLoanDTO {
    ...
    // Full Constructor
    public PawnLoanDTO(String loanId, String pawnItemId, String customerId,
    ...
    public PawnLoanDTO(String loanId, String customerName, String customerNic,
    ...
    public PawnLoanDTO(String pawnType, String loanId, String itemName, String startdate, double weight, double pricePerGram, String loanmonth) {
        this.pawnType = pawnType;
        this.loanId = loanId;
        this.itemName =itemName;
        this.startDate = startdate;
    ...
    public PawnLoanDTO(String pawnType, String loanId, String itemName, String startdate, double weight, double pricePerGram, String goldCarat, String loanMonth) {
        this.pawnType = pawnType;
        this.loanId = loanId;
        this.itemName =itemName;
        this.startDate = startdate;
    ...
    public PawnLoanDTO(String pawnType, String itemName, double weight, String goldCarat, double pricePerGram) {
        this.pawnType = pawnType;
        this.itemName = itemName;
        this.weight = weight;
        this.goldCarat = goldCarat ;
    ...
    public PawnLoanDTO(String loanId,String customerName,String customerNic,String customerPhone,String customerAddress,double totalWeight,double loanAmount,double stampFee,double interestRate,double netValue) {
        this.loanId = loanId;
        this.customerName = customerName;
        this.customerNic = customerNic;
        this.customerPhone = customerPhone;
