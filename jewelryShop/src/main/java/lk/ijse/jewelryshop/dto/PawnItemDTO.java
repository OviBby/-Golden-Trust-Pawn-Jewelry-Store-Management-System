...
public class PawnItemDTO {
    ...
    public PawnItemDTO(String pawnItemId,String description,double weight,String purity,String currentStatus,double estimatedValue,String acquiredDate,double currentValue) {
