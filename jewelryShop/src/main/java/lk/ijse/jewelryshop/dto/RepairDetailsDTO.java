...
public class RepairDetailsDTO {
    ...
    public RepairDetailsDTO(String repairId, String customerName, String repairDate, String status, String submittedDate, String completedDate, double estimatedCost, String repairDescription, double advancepayment, double amount) {
    ...
    public RepairDetailsDTO(String repairId, String customerName, String repairDescription, String submittedDate, String status, Double estimatedCost) {
        this.repairId = repairId;
        this.customerName = customerName;
        this.submittedDate = submittedDate;
        this.repairDescription = repairDescription;
    ...
    public RepairDetailsDTO(String repairItemId, String customerName, String completedDate, String repairDescription, Double estimatedCost, Double advancePayment, Double amount) {
    ...
    public RepairDetailsDTO(String customerName, String repairDescription, String submittedDate, String status, double estimatedCost) {
        this.customerName = customerName;
        this.repairDescription = repairDescription;
        this.submittedDate = submittedDate;
        this.status = status;
