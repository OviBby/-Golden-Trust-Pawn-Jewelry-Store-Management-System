...
import lk.ijse.jewelryshop.dao.custom.DashboardDAOImpl;
import lk.ijse.jewelryshop.dao.custom.RepairItemDAOImpl;
...
public class CashierDashboardController implements Initializable {
    ...
    private void loadAllRepairItem() {
        try{
            repairitems.clear();
            repairitems.addAll(dao.getAllRepairItem());
    ...
    private void loadMonthlyRevenueChart() {
        try {
            ...
            // Sample data - ඔයාගේ database එකෙන් load කරන්න පුළුවන්
